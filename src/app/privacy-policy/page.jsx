    ...
    return (
        <div className="container mx-auto py-16 px-4 md:px-6">
            <div className="max-w-4xl mx-auto prose prose-lg text-muted-foreground">
                ...
                <ul>
                    ...
                    <li>
                        <p>
                            ...
                            refers to Timeless Web, 58 Dora Street, Sydney NSW
                            2220.
                        </p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p>
                            <strong>Website</strong> refers to Timeless Web,
                            accessible from{" "}
                            <a
                                href="https://timelessweb.com.au"
                                rel="external nofollow noopener"
                                target="_blank"
                            >
                                https://timelessweb.com.au
                            </a>
                        </p>
                    </li>
                    <li>
                ...
                <ul>
                    <li>By email: connect@timelessweb.com.au</li>
                </ul>
            </div>
        </div>
    );
